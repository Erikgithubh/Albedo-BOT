...
/*============== NOMOR ==============*/
global.nomorbot = '6285920792778'
global.nomorown = '62881025400447'
global.namebot = 'DuckBotz'
global.nameown = 'Yiksz'
...
/*============== WATERMARK ==============*/
global.wm = '                「 Duck-BOT 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Duck-BOT ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Duck-BOT '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Zenss`
global.packname = 'Duck-Botz WhatsApp'
global.author = '                「 Duck-BOT  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'Duck-BOT'
global.stickauth = `By ©Yiksz`
